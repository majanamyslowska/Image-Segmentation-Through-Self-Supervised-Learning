...
class CATSNDOGS_PICANET_Segmentation(torch.utils.data.Dataset):

    def __init__(self, root=Path.db_root_dir('CATSNDOGS_PICANET'),
                 saliency='supervised_model',
                 transform=None, overfit=False):
        super(CATSNDOGS_PICANET_Segmentation, self).__init__()
    ...
    def __str__(self):
        return 'CATSNDOGS_PICANET(saliency=' + self.saliency + ')'
...
if __name__ == '__main__':
    ...
    dataset = CATSNDOGS_PICANET_Segmentation(saliency='supervised_model')
