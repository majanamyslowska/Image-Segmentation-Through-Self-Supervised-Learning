...
class IMAGENET_SAMPLE_Segmentation(torch.utils.data.Dataset):

    def __init__(self, root=Path.db_root_dir('IMAGENET_SAMPLE'),
                 saliency='supervised_model',
                 transform=None, overfit=False):
        super(IMAGENET_SAMPLE_Segmentation, self).__init__()
    ...
    def __str__(self):
        return 'IMAGENET_SAMPLE(saliency=' + self.saliency + ')'
...
if __name__ == '__main__':
    ...
    dataset = IMAGENET_SAMPLE_Segmentation(saliency='supervised_model')
