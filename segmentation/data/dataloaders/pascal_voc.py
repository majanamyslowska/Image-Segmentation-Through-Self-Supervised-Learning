...
class VOC12(data.Dataset):
    ...
    def _load_semseg(self, index):
        ...
        save_path = f"/cs/student/msc/dsml/2023/mdavudov/ADL/MaskContrast/segmentation/data/{self.split}_VOC/{os.path.basename(self.semsegs[index])}"  # Adjust the filename as needed
